...
import { useGetEarningGrowthQuery} from "../page/redux/api/metaDataApi";
import { Select } from "antd";

const { Option } = Select;

export default function EarningGrowth() {
  const [year, setYear] = useState("2025");

  const { data: orderGrowth, isLoading } = useGetEarningGrowthQuery({ year });
